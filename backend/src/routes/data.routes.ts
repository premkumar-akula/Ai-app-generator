...
import { listRecords, getRecord, createRecord, updateRecord, deleteRecord, aggregateStats, getEntityFromConfig } from '../services/data.service';
import { AppConfig } from '../types/config.types';
import multer from 'multer';
import csvParser from 'csv-parser';
import { Readable } from 'stream';
import { bulkCreate } from '../services/data.service';
...
router.get('/:entity', authenticate, async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    // Find searchable fields from entity definition
